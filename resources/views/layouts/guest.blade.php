...
@props(['card' => 'sm:max-w-2xl']) {{-- <- lebar default, bisa di-override --}}
...
<body class="font-sans text-gray-900 antialiased">
    <div class="relative min-h-dvh flex flex-col items-center justify-center bg-gray-100">
        {{-- Background --}}
        ...
        <div class="relative z-10 flex w-full flex-col items-center justify-center px-4">
            ...
            <div class="mb-6">
                <a href="{{ route('home') }}">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo" class="w-24 h-24 rounded-full shadow-lg transition-transform duration-300 hover:scale-110" loading="lazy" decoding="async">
                </a>
            </div>
            ...
            {{-- Card konten (login/register/forgot) --}}
